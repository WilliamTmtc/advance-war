...
public abstract class OwnableBuildingRenderer
    extends BuildingRenderer.BuildingRender {
    ...
    public void updateState() {
        String s;
        Color c = ((OwnableBuilding)building).isNeutral()
                      ? Color.WHITE
                      : ((OwnableBuilding)building).getOwner().getColor();
    ...
    public void updateState(String s) { updateState(); }
}