...
public enum Direction {
    ...
    /**
     * Translate the given point by the given direction (multiplicated by the
     * increment)
     * @param pt is the point to move
     * @param incr is the increment
     */
    public void move(Point pt, int incr) { pt.translate(x * incr, y * incr); }

    /**
     * @param pt is the point we want to move
     * Move to point accordingly to the direction
     */
    public void move(Point pt) { move(pt, 1); }

    /**
     * @return the direction opposed to this
     */
    public Direction opposed() { return Direction.opposed(this); }
    ...
    /**
     * @return an array of the 4 cardinal directions, in order : LEFT, TOP,
     *     RIGHT, BOTTOM
     */
     ...
     * @return the direction to go from the departure to the arrival, return
     *     NONE if the points aren't adjacents
     */
