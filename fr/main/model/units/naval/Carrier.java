...
public class Carrier extends Unit implements NavalUnit, TransportUnit {
    ...
    public Carrier(Player player, Point point) {
        super(player, point, fuelName, 99, true, MoveType.NAVAL, 5, 4,
              new PrimaryWeapon(PRIMARYWEAPON_NAME, 9, 3, 8,
                                PRIMARYWEAPON_DAMAGES, false),
              null, NAME, PRICE);
    }
    ...
    public boolean canAttackAfterMove() { return false; }
