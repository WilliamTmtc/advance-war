...
public abstract class OwnableBuilding extends Building {
    ...
    public OwnableBuilding(Player p, Point pos, int defense, int maximumLife,
                           int income, String name) {
     ...
     */
    public boolean isNeutral() { return owner == null; }
    ...
    public void goBackToMaximumLife() { life = maximumLife; }
}
