...
public abstract class Weapon implements java.io.Serializable {
    ...
    /**
     * true if and only if the weapon can be used after a move (most of the time
     * it is not possible for ranged weapons)
     */
    ...
    /**
     * @return true if and only if the shooter can shoot the target with this
     *     weapon (so if and only if it still has ammo, the unit is in range and
     *     can be shot).
     */
    public abstract boolean canAttack(AbstractUnit shooter,
                                      AbstractUnit target);
    public abstract boolean isInRange(AbstractUnit shooter,
                                      AbstractUnit target);
     ...
     */
    public abstract void renderTarget(boolean[][] map, AbstractUnit u, int x,
                                      int y);
    ...
    /**
     * @return true if and only if this weapon can shoot this unit (whatever the
     *     distance or ammo).
     */
    ...
    /**
     * @return an Integer whose intValue is the damage inflicted by this weapon
     *     to the unit given as a parameter. Returns null if this weapon cannot
     *     attack the unit given in parameter.
     */
    public Integer damage(AbstractUnit u) {
        if (u != null)
            for (Map.Entry<Class<? extends AbstractUnit>, Integer> e :
                 damages.entrySet())
