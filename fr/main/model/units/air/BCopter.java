...
public class BCopter extends Unit implements CopterUnit {
    ...
    public BCopter(Player p, int x, int y) { this(p, new Point(x, y)); }

    public BCopter(Player player, Point point) {
        super(player, point, fuelName, 99, true, MoveType.AIRY, 6, 3,
              new PrimaryWeapon(PRIMARYWEAPON_NAME, 6, PRIMARYWEAPON_DAMAGES,
                                true),
              SECONDARYWEAPON, NAME, PRICE);
    }

    public int getFuelTurnCost() { return 2; }
}