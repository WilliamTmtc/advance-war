...
public class Stealth extends Unit implements PlaneUnit, HideableUnit {
    ...
    public Stealth(Player p, int x, int y) { this(p, new Point(x, y)); }

    public Stealth(Player player, Point point) {
        super(player, point, fuelName, 60, true, MoveType.AIRY, 6, 4,
    ...
    public int getFuelTurnCost() { return (hidden) ? 5 : 2; }
}