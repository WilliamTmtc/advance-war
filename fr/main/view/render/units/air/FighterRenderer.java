...
public class FighterRenderer extends UnitRenderer.Render {
    ...
    public FighterRenderer(AbstractUnit unit) {
        ...
        AnimationState idleRight =
            new AnimationState(new SpriteList(getDir() + "air.png", areas), 50);
        ...
        AnimationState moveRight =
            new AnimationState(new SpriteList(getDir() + "air.png", areas), 15);
        ...
        areas = new LinkedList<>();
        areas.add(
            new ScaleRect(90, 50, 15, 20, 2, ScaleRect.Flip.HORIZONTALLY));
        areas.add(
            new ScaleRect(90, 52, 15, 20, 2, ScaleRect.Flip.HORIZONTALLY));
