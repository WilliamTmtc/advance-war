...
public interface TransportUnit extends AbstractUnit {
     ...
     */
    public default int getOccupation() { return getUnits().size(); }
    /**
     ...
     * @param x is the horizontal coordinate of the tile we want to drop the
     *     unit on
     * @param y is the vertical coordinate of the tile we want to drop the unit
     *     on
