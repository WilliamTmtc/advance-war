...
public interface AbstractTerrain extends java.io.Serializable {
     ...
     * 0 : all others
     *
     * flying units are considered to have a height of 2 whatever the terrain,
     * landunits and navalunits have the height of their terrain
     */
    int getHeight();
     ...
     * @return true if and only if the terrain hides its content from the unit
     *     given in parameter
     */
     ...
     * @return true if and only if the unit can go in the terrain with the
     *     current weather
     */
     ...
     * @param w is the weather
     * @param mt is the move type of the unit moving
     * @return an Integer which is null if the move type can't go on the terrain
     *     and the value of the move cost otherwise
     */
    ...
    default boolean canStop(AbstractUnit u) { return canStop(u.getMoveType()); }
