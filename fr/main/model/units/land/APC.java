 ...
 */
public class APC
    extends Unit implements LandVehicleUnit, TransportUnit, SupplyUnit {
    ...
    public APC(Player player, Point point) {
        super(player, point, fuelName, 70, false, MoveType.TREAD, 6, 1, null,
              null, NAME, PRICE);
    }

    public APC(Player player, int x, int y) { this(player, new Point(x, y)); }
    ...
    public boolean canSupply(AbstractUnit u) {
        return u != null && u.getPlayer() == this.getPlayer() &&
            u.getFuel() != null;
    }
}