...
public class HubController extends Controller {
    ...
    public HubController(Client client) {
        ...
        readyAction = e -> {
            ...
            if (ready)
                source.setText("Ready to play");
            else
                source.setText("Not Ready to play");
            ready = !ready;
        };
    ...
    private Slot slot() { return new Slot(client.id, view.getName(), ready); }
    ...
    public int getID() { return client.id; }
}
