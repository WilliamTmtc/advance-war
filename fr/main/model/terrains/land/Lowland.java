...
public class Lowland extends Terrain implements LandTerrain {
    ...
    protected static final Map<Weather, Map<MoveType, Integer>>
        weatherMovementCosts = new HashMap<Weather, Map<MoveType, Integer>>();

    static {
        Map<MoveType, Integer> sunnyWeatherMovementCosts =
            new HashMap<MoveType, Integer>();
        ...
        Map<MoveType, Integer> rainyWeatherMovementCosts =
            new HashMap<MoveType, Integer>();
        ...
        Map<MoveType, Integer> snowyWeatherMovementCosts =
            new HashMap<MoveType, Integer>();
    ...
    protected Lowland() { super(name, 1, 0, weatherMovementCosts); }
