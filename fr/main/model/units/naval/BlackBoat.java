 ...
 */
public class BlackBoat
    extends Unit implements NavalUnit, HealerUnit, TransportUnit, SupplyUnit {
    ...
    public BlackBoat(Player player, Point point) {
        super(player, point, fuelName, 60, true, MoveType.LANDER, 7, 1, null,
              null, NAME, PRICE);
    }
