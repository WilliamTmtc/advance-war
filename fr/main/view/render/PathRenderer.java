            ...
            if (u != null && u.getPlayer() != unit.getPlayer()) {
                if (u.canAttack(unit)) {
                    ...
                    world.flash(
                        ...
                        (unit.getY() - camera.getY()) * MainFrame.UNIT + 5,
