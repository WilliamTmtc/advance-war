...
public class Infantry extends Unit implements WalkingUnit, CaptureBuilding {
    ...
    public Infantry(Player p, int x, int y) { this(p, new Point(x, y)); }

    public Infantry(Player player, Point point) {
        super(player, point, WalkingUnit.FUEL_NAME, 99, false,
              MoveType.INFANTRY, 3, 2, null, SECONDARYWEAPON, NAME, PRICE);
    }
