...
public class Sub extends Unit implements NavalUnit, HideableUnit {
    ...
    public Sub(Player player, Point point) {
        super(player, point, fuelName, 60, true, MoveType.NAVAL, 5, 5,
    ...
    public Sub(Player player, int x, int y) { this(player, new Point(x, y)); }
    ...
    public int getFuelTurnCost() { return (hidden) ? 3 : 1; }
}