...
public class MusicEngine {
    ...
    private void playMusic() {
        try {
            ...
            while ((count = audioStream.read(tempBuff, 0, tempBuff.length)) !=
                   -1) {
                synchronized (this) {
                    while (!run)
                        wait();
    ...
    public void stop() { new Thread(this::stopMusic).start(); }

    // continue the music
    public void continues() { new Thread(this::continueMusic).start(); }
}
