...
public class DayPanel extends InterfaceUI {
    ...
    private static final int HEIGHT = 200, MARGINTOP =
                                               MainFrame.height() / 2 - HEIGHT;

    public DayPanel() { super(false); }
    ...
    public void draw(Graphics g) {
        ...
        g.drawString("Day " + Universe.get().getDay(),
                     MainFrame.width() / 2 - 100, MARGINTOP + 50);
    }
