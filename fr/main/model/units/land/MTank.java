...
public class MTank extends Unit implements TankUnit {
    ...
    public MTank(Player p, int x, int y) { this(p, new Point(x, y)); }

    public MTank(Player player, Point point) {
        super(player, point, fuelName, 50, false, MoveType.TREAD, 5, 1,
              new PrimaryWeapon(PRIMARYWEAPON_NAME, 8, PRIMARYWEAPON_DAMAGES,
                                true),
